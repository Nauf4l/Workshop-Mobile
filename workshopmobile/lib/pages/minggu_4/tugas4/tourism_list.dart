...
class tourismList extends StatefulWidget{
  ...
  const tourismList ({
    Key? key,
    required this.doneMakananIndonesiaList
  }) : super (key: key);

  @override
  _tourismListState createState() => _tourismListState(doneMakananIndonesiaList);
}
...
class _tourismListState extends State<tourismList>{
  ...
  _tourismListState(this.doneMakananIndonesiaList);
    ...
    return ListView.builder(
        itemBuilder: (context, index) {
          ...
          return InkWell(
            ...
            child: ListItem(
              place: place,
              isDone: doneMakananIndonesiaList.contains(place),
              onCheckboxClick: (bool? value){
                setState(() {
                  if(value!=null){
                    value ? doneMakananIndonesiaList.add(place) : doneMakananIndonesiaList.remove(place);
                  }
                });
              }
            ),
